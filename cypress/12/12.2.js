...
//planets.forEach(element => console.log("Planet: " + element.planet, "Radius: " + element.radius,
 //   "Density: " + element.density, "Distance: " + element.distance))

//task 2

let new_planets = planets.map((element) => [element].system="SolarSystem")
