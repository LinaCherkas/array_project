...
planetsMap.set(planetsArray[key].planet, {"radius":planetsArray[key].radius,"density":planetsArray[key].density,
...
it('Task 3:', () => {
    ...
    let printPlanet = Object.keys(planet).map(key => key + ':' + planet[key]).join(', ')
...
it('Task 5:', () => {
    ...
    set_variable.forEach(element => {if (planetsMap.has(element)) cy.log("Mercury exists")})
})
...
//task 7
it('Task 7:', () => {
    let planetsMap2 = new Map([["TestPlanet1", {"radius":"45674","density":"5647689",
        "distance":"467987"}], ["TestPlanet2", {"radius":"35685","density":"12345",
        "distance":"76547"}]])
...
//task 8
it('Task 8:', () =>{
    planetsArray.forEach((element) => { for (let key in element)
    {
